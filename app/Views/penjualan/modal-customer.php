<div class="modal fade" id="modalCust" aria-hidden="true" 
    ...
    <tbody>
      ...
      foreach ($dataCust as $value) : ?>
        <tr>
          ...
          <td>
          <button onclick="selectCustomer ('<?= $value['customer_id'] ?>','<?= $value['name']  ?>')"  class="btn btn-success"><i class="fa fa-cart-plus"></i>Pilih</button>
