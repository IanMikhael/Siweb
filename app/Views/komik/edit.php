            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('/komik/edit/' . $result['komik_id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('judul') ?
                                                                        'is-invalid' : '' ?>" id="judul" name="judul" value="<?= old('judul', $result['judul']) ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('penulis') ?
                                                                        'is-invalid' : '' ?>" id="penulis" name="penulis" value="<?= old('penulis', $result['penulis']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control <?= $validation->hasError('tahun_rilis') ?
                                                                        'is-invalid' : '' ?>" id="tahun_rilis" name="tahun_rilis" value="<?= old('tahun_rilis', $result['tahun_rilis']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control <?= $validation->hasError('stok') ?
                                                                        'is-invalid' : '' ?>" id="stok" name="stok" value="<?= old('stok', $result['stok']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control <?= $validation->hasError('harga') ?
                                                                        'is-invalid' : '' ?>" id="harga" name="harga" value="<?= old('harga', $result['harga']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <a class="btn btn-danger" type="button" href="/book">Batal</a>
