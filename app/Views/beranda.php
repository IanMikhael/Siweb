        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card mb-4">
                    ...
                    <div class="d-grip gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-outline-primary btn-sm" onclick="downloadChartTransaksi('PDF')">Unduh PDF
                        </button>
            ...
            <div class="col-xl-6">
                <div class="card mb-4">
                    ...
                    <div class="d-grip gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-outline-primary btn-sm" onclick="downloadChartCustomer('PDF')">Unduh PDF
                        </button>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card mb-4">
                    ...
                    <div class="d-grip gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-outline-primary btn-sm" onclick="downloadChartPembelian('PDF')">Unduh PDF
                        </button>
            ...
            <div class="col-xl-6">
                <div class="card mb-4">
                    ...
                    <div class="d-grip gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-outline-primary btn-sm" onclick="downloadChartSupplier('PDF')">Unduh PDF
                        </button>
...
<script>
    ...
    function setLineChartx(dataset) {
        // Area Chart Example
    ...
    function setPieChart(dataset) {
        ...
        var myPieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: dataset,
                    backgroundColor: ['#007bff', '#dc3545', '#ffc107', '#28a745', '#FFC0CB', '#BF00FF','#FF007F' ],
                }],
            },
        });
    }
    
    function setPolarChart(dataset) {
