                ...
                <tbody>
                    ...
                    foreach ($result as $value) : ?>
                        <tr>
                            ...
                            <td width="20%" class="left"><?= $value['firstname'] ?></td>
                            <td width="25%" class="left"><?= $value['name_supp'] ?></td>
                            <td width="15%" class="right"><?= number_to_currency($value['total'], 'IDR', 'id_ID', 2) ?></td> -->

                            <td width="5%"><?= $no++ ?></td>
                            <td width="15%"><?= $value['buy_id'] ?></td>
                            <td width="20%"><?= date("d/m/Y H:i:s", strtotime($value['tgl_transaksi'])) ?></td>
                            <td width="20%" class="left"><?= $value['title'] ?></td>
                            <td width="15%"><?= $value['stock'] ?></td>
